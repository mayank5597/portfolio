  ...
  const projects = [
    {
      ...
      description: "AI-driven web interface with secure SSO authentication, chatbot integration, and document management.",
      challenge: "Build animated, responsive UI with complex AI model integration",
      solution: "Implemented React + Tailwind with shadcn/ui, optimized API layers, CDN-based asset delivery",
    ...
    },
    {
      ...
      role: "React Developer",
      description: "In-house appointment scheduler with Google Calendar sync, form handling, and type-safe development.",
      challenge: "Integrate multiple services while maintaining clean architecture",
      solution: "Redux state management, TypeScript, React Hook Form + Zod validation, AWS deployment",
      impact: "Streamlined appointment management for healthcare providers",
      tech: ["React", "Redux", "TypeScript", "Google Calendar API", "AWS", "Vercel"],
      metrics: { performance: "92%", deployments: "Multi-cloud" },
    },
    {
      name: "SalesBot.AI",
      role: "MERN Developer",
      description: "Chat-based AI sales assistant with role-based access (User & Admin) and backend AI integration.",
      challenge: "Create intuitive chat UI with complex backend AI workflows",
      solution: "MERN stack with Docker containerization, optimized frontend performance",
      impact: "Automated sales outreach with intelligent conversation handling",
      tech: ["MongoDB", "Express.js", "React", "Node.js", "Docker", "AI Integration"],
      metrics: { roles: "2", deployment: "Containerized" },
    },
    {
      name: "MyScoot (Exly)",
      role: "Next.js Developer",
      description: "Product tours and recommendation engine with CI/CD pipeline integration.",
      challenge: "Architect scalable product recommendation system",
      solution: "Next.js with TypeScript, React-based tours, partnered with data science team",
    ...
    },
    {
      ...
      description: "Complex data visualization platform with SSR/SSG, featuring charts, graphs, and email templates.",
      challenge: "Handle large datasets with optimal rendering performance",
      solution: "React Query + Zustand, Storybook testing, SSR/SSG optimization, custom chart integrations",
      impact: "High-performance data dashboards with extensive test coverage",
      tech: ["Next.js", "Node.js", "React Query", "Zustand", "Chart.js", "D3.js", "Storybook"],
      metrics: { testing: "High Coverage", rendering: "SSR/SSG" },
    },
    {
      name: "Nana & Saal.ai",
      role: "Next.js & React Native Developer",
      description: "Large dataset handling with optimized component rendering and lifecycle management.",
      challenge: "Performance optimization for data-intensive mobile and web apps",
      solution: "Advanced React lifecycle practices, efficient data rendering strategies",
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-heading font-semibold tracking-tight mb-6">
            <span className="gradient-text">Proof</span> Over Claims
          </h2>
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
            Each project is a story of challenges conquered, solutions crafted, and impact delivered.
          </p>
        </motion.div>
...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    ...
    >
      <div className={`relative bg-card/40 backdrop-blur-xl border border-white/10 rounded-xl overflow-hidden transition-all duration-500 hover:border-primary/50 ${
        ...
        <div className="relative p-6 md:p-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
            ...
            <Code2 className="hidden md:block w-6 h-6 text-accent mt-2 md:mt-0" />
          </div>
